  ...
  void Presentation()
    {
     ...
     printf ( " %s", "================================================================================================" ) ;
     printf ( " %s", "          Realisé par:                                                                " ) ;
     printf ( " %s", "                        ○ AOUAOUCHE Louiza                    GROUPE 02 1CPI-A 2017/2018    " ) ;
     printf ( " %s", "                        ○ MECHOUEK Lounes    " ) ;
     printf ( " %s", "                                                         " ) ;
     printf ( " %s", "          Encadrés par:                                                       " ) ;
     printf ( " %s", "                  ○Dr ZEGOUR                  ○Dr KERMI                  ○Dr HIDOUCI   " ) ;
     printf ( " %s", "                   " ) ;
     printf ( " %s", "================================================================================================" ) ;
     printf ( " %s", "" ) ;
     printf ( " %s", "-------------------------------------------------------------------------------------------- " ) ;
     printf ( " %s", "                        INSERTION ALEATOIRE :" ) ;
     printf ( " %s", "--------------------------------------------------------------------------------------------" ) ;
     printf ( " %s", "" ) ;
     printf ( " %s", "    MOTS GENERES ET RANGES DANS LE TABLEAU: " ) ;
     printf ( " %s", "" ) ;
     printf ( " %s", "=========================================" ) ;
  ...
  int main(int argc, char *argv[])
    {
     Tab = malloc(1000 * 255  * sizeof(string255));
     int _Izw2;for (_Izw2=0; _Izw2<1000; ++_Izw2)
       Tab[_Izw2]= malloc(255 * sizeof(string255));
     ...
     for( I  =  1 ;I <=  Maxi ; ++I){
       Long  =  Aleanombre(L ) + 1 ;
       if( ( Long != 0 )) {
         strcpy (Mot,   Aleachaine(Long )) ;
         Aff_element_V1000s(Tab , I   , Mot ) ;
         printf ( " %s", "* MOT:  " );
         printf ( " %s", Mot ) ;
         printf ( " %s", "* TAILLE:  " );
         printf ( " %d", Longchaine(Mot) ) ;
         printf ( " %s", "=========================================" ) ;
         ...
         if( ( Maillon == NULL )) {
           ...
           if( ( Erreur == True )) {
             printf ( " %s", "INSERTION IMPOSSIBLE : CHAINE DEJA PRESENTE" ) ;
             Erreur  =  False ;
     ...
     P  =  Tete ;
     printf ( " %s", "-------------------------------------------------------------------------------------------- " ) ;
     printf ( " %s", "      RANGEMENT DES MOTS GENERES DANS LA STRUCTURE (par ordre lexicographique) :" ) ;
     printf ( " %s", "--------------------------------------------------------------------------------------------" ) ;
     while( ( ( ! Stop ) && ( P != NULL ) )) {
       printf ( " %s", "-------> Maillon de taille :" );
       printf ( " %d", Longchaine(Info_As(Valeur_RAs(P))) ) ;
       _Px1 =  Valeur_RAs(P ) ;
       Inordre ( &_Px1) ;
       printf ( " %s", "=====================================================" ) ;
       P  =  Suivant_RAs(P ) ;
    ...
    /*                                                                                            */
     printf ( " %s", "" ) ;
     printf ( " %s", "-------------------------------------------------------------------------------------------- " ) ;
     printf ( " %s", "                       SUPPRESSION DES MOTS DE LA STRUCTURE:" ) ;
     printf ( " %s", "--------------------------------------------------------------------------------------------" ) ;
     printf ( " %s", "" ) ;
     printf ( " %s", "=====================================================" ) ;
     J  =  Maxi ;
     for( I  =  1 ;I <=  Maxi ; ++I){
       strcpy (Mot,   Element_V1000s(Tab , J   )) ;
       printf ( " %s", "MOT:  " );
       printf ( " %s", Mot ) ;
       printf ( " %s", "TAILLE:  " );
       printf ( " %d", Longchaine(Mot) ) ;
       Recherche_sup ( & Tete , & Mot , & Maillon , & Suiv , & Prec ) ;
       Sup_noeud ( & Maillon , & Mot , & Erreur ) ;
       if( ( Erreur == True )) {
         printf ( " %s", "---> MOT DEJA SUPPRIME " ) ;
         Erreur  =  False ;

       } ;
       if( ( Valeur_RAs(Maillon ) == NULL )) {
         Sup_maillon ( & Maillon , & Tete ) ;
