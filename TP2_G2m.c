...
#include<string.h>
  ...
  void Aff_val_RAs(Pointeur_RAs P, Pointeur_As V)
    { P->Val = V ; }
  ...
  Pointeur_RAs P;
  Typevect_V1000s Tab;
  Pointeur_As N,Nesl,Pere;
  bool Erreur;
  bool Stop;
  int Maxi;
  int I;
  int J;
  int L, confirm=0, pos=0;
  int Long;
  string255 Mot;
  Pointeur_As _Px1;
 ...
 /*****************************************************************************************************************************************/
  ...
  int main(int argc, char *argv[])
   ...
   /* printf("%s","Tout s'est deroule avec succes ! \n");*/
    system("PAUSE");
      return 1;
